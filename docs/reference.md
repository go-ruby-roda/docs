...
The public API lives at the module root (`github.com/go-ruby-roda/roda`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `roda`, while the surface follows
...
```go
import "github.com/go-ruby-roda/roda"
```
...
- **[pkg.go.dev/github.com/go-ruby-roda/roda](https://pkg.go.dev/github.com/go-ruby-roda/roda)**

The module's [README](https://github.com/go-ruby-roda/roda#readme) carries worked
