# go-ruby-roda documentation

**Pure-Go, MRI-4.0.5-faithful Ruby roda (no cgo)**

`go-ruby-roda/roda` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `roda`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-roda/roda`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `roda`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`roda`](https://github.com/go-ruby-roda/roda) | the library — Ruby's `roda` in pure Go |
| [`docs`](https://github.com/go-ruby-roda/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-roda.github.io`](https://github.com/go-ruby-roda/go-ruby-roda.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-roda/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-roda/roda](https://github.com/go-ruby-roda/roda).
